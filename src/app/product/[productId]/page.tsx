        ...
        <MaxWidthWrapper>
            <div className="bg-white">
                <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
                    ...
                    {/* add to cart part */}
                    <div className="mt-10 lg:cols-start-1 lg:row-start-2 lg:max-w-lg lg:self-start">
                        <div>
                            <div className="mt-10">
                                <AddToCartButton />
                            </div>
                            <div className="mt-6 text-center">
                                <div className='group inline-flex text-sm text-medium'>
                                    ...
                                    <span className="text-mitted-foreground hover:text-gray-700">30 Day Return Guarantee</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <ProductReel 
                href="/products" query={{category: product.category, limit: 4}} 
                title={`Similar ${label}`}
